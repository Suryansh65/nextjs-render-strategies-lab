...
export default async function DashboardPage() {
  const data: dashboardInfo[] = await getDashboardData();
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="font-normal my-2 text-sm text-gray-600">
          This dashboard is rendered on the server at request time (SSR). Click
          any card below to open a page that uses Incremental Site Generation
          (ISR).
        </p>
